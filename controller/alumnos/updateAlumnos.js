...
exports.updateAlumnos = async function(req, res, next) {
  ...
  */
  ...
  let alumno;
  alumno = await pg.func('public.ft_proc_update_alumno', JSON.stringify(req.body)).catch(err => {
    console.log(err)
  })
  ...
  if (alumno.length == 0) {
    ...
    res.send({
      status: alumno[0]["ft_proc_update_alumno"]
    })
  }
